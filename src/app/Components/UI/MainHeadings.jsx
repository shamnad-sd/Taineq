...
const MainHeadings = ({
    ...
    return (
        <div>
            {
                Heading ? <h3 className="uppercase tracking-wide Secondary-color font-semibold text-base  md:text-[18px] mb-3 inline-flex items-center gap-3">
            ...
            <div
                ...
                className={`paragraph-color content text-[17px] mb-8 max-w-[50rem] space-y-6`} 
                />
        </div>
    )
}
